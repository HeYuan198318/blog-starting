...
//        Cipher cipher = Cipher.getInstance("AES");
    ...
    public static final String DES3KEY = "#selfAudit1.0_dataSource";

//    public static void main(String[] args) throws Exception {
//       String st = encryptThreeDESECB("kappa", DES3KEY);
//      //  String jm = decryptThreeDESECB("hdVgD9FCrY3DPlrkQ1zB2Q==", DES3KEY);
